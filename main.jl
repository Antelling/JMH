...
function main(;verbose::Int=0)
	for dataset in [3, 4, 5]
		...
		algorithms = [(control_monad(), "control"),
			...
			(iterate_monad(sloppy_jaya_monad(top_n=30, bottom_n=30)), "J30"),
			...
			(iterate_monad(sloppy_jaya_monad(local_search=VND, top_n=30, bottom_n=30)), "J30_ls"),

			(iterate_monad(sloppy_jaya_monad(top_n=1, bottom_n=1, v2=v2)), "J1_v2"),
			(iterate_monad(sloppy_jaya_monad(top_n=3, bottom_n=3, v2=v2)), "J3_v2"),
			(iterate_monad(sloppy_jaya_monad(top_n=7, bottom_n=7, v2=v2)), "J7_v2"),
			(iterate_monad(sloppy_jaya_monad(top_n=15, bottom_n=15, v2=v2)), "J15_v2"),
			(iterate_monad(sloppy_jaya_monad(top_n=30, bottom_n=30, v2=v2)), "J30_v2"),

			(iterate_monad(sloppy_jaya_monad(local_search=VND, top_n=1, bottom_n=1, v2=v2)), "J1_ls_v2"),
			(iterate_monad(sloppy_jaya_monad(local_search=VND, top_n=3, bottom_n=3, v2=v2)), "J3_ls_v2"),
			(iterate_monad(sloppy_jaya_monad(local_search=VND, top_n=7, bottom_n=7, v2=v2)), "J7_ls_v2"),
			(iterate_monad(sloppy_jaya_monad(local_search=VND, top_n=15, bottom_n=15, v2=v2)), "J15_ls_v2"),
			(iterate_monad(sloppy_jaya_monad(local_search=VND, top_n=30, bottom_n=30, v2=v2)), "J30_ls_v2"),
		]
	    ...
	    for problem in problems
	        ...
	        swarm = greedy_construct(problem, 30, repair_op=identity, local_search=VND, verbose=1, max_attempts=500_000)
